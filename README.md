...
[<img src="https://deploy.cloud.run/button.svg" alt="Run on Google Cloud" height="40"/>](https://deploy.cloud.run?git_repo=https://github.com/MannyHackers/botkaca.git "Google Cloud")
[<img src="https://www.herokucdn.com/deploy/button.svg" alt="Deploy to Heroku" height="40"/>](https://heroku.com/deploy?template=https://github.com/MannyHackers/botkaca "Heroku")
...
# get botkaca source
git clone https://github.com/MannyHackers/botkaca.git

# build then execute using docker image
docker build -t MannyHackers/botkaca botkaca
docker run -it MannyHackers/botkaca
```
